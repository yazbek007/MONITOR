...
class NtfyNotifier:
    ...
    def test_connection(self):
        ...
        try:
            ...
            if response.status_code == 200:
                logger.info("Ntfy connection test successful")
                return True
            else:
    ...
    def send_message(self, message, message_type='info', title=None):
        ...
        try:
            if not self.topic or not self.base_url:
                logger.debug("Ntfy not configured, skipping notification")
                return False
            ...
            logger.info(f"Sending Ntfy notification to {self.base_url}")
